...
- [Live Demo Link](https://mathsmagicians.onrender.com/)
...
```sh
  git https://github.com/emmanuelsteven/mathsMagician.git
  cd Math-Magicians
```
...
Feel free to check the [https://github.com/emmanuelsteven/mathsMagician/issues](issue page).
